...
<html lang="en-US">
  <head>
    <meta charset="UTF-8">
    <title>New Thread | Syndica</title>
...
<div class="container">
  <div class="card my-4">
    <div class="card-header bg-primary text-white">
      <div class="h4 mb-0">New Discussion</div>
    </div>
    <div class="card-body">
        <form class="m-0" action="/newthread" method="post">
            <div class="form-group">
              <label for="title"><b>Title:</b></label>
              <input class="form-control" type="text" name="title" required>
            </div>
            <div class="form-group">
              <label for="url"><b>Web Link:</b></label>
              <input class="form-control" type="text" name="url" placeholder="https://www.google.com" required>
            </div>
            <textarea class="form-control" name="body" placeholder="Start an open discussion ..." rows=4></textarea><br><br>
            <input class="btn btn-secondary" type="submit" name="newthread" value="Create">
        </form>
    </div>
  </div>
</div>
