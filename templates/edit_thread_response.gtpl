<!-- dl/edit_thread_response.html -->
<!DOCTYPE html>
<html lang="en-US">
  <head>
    <meta charset="UTF-8">
    <title>Edit Response | Syndica</title>
...
<div class="container">
  <div class="card my-4">
    <div class="card-header bg-primary text-white">
      <div class="h4 mb-0">Edit Response</div>
    </div>
    <div class="card-body">
      <form method="post" action="/threadreply_edit?id={{.ID}}&tid={{.DiscussionID}}">
        <div class="form-group">
          <label for="answer"><b>Response:</b></label>
          <textarea class="form-control" rows="6" name="comment" required>{{.Comment}}</textarea>
        </div>
