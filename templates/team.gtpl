...
<html lang="en-US">
  ...
  <body class="bg-light" onload="LoadTeamQuestions();">
        ...
        <div class="container pt-4">
          ...
          <div class="card mb-4">
            ...
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
              ...
              <form class="m-0" action="/newmessage" method="get">
                <input class="btn btn-secondary" type="submit" name="newquestion" value="+ New Discussion">
              </form>
            </div><!-- .card-header -->

            <div class="card-body p-0">

              <div id="teamquestions"></div><!-- #questions -->
