...
<div class="container">
  <div class="card my-4">
    ...
    <div class="card-body">
      <form method="post" action="/response_edit?company={{.Company}}&qid={{.QID}}&rid={{.RID}}">
        <div class="form-group">
          <label for="answer"><b>Response:</b></label>
          <textarea class="form-control" rows="6" name="answer" required>{{.Answer}}</textarea>
        </div>
