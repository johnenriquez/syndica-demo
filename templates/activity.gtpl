<!-- advisorsview_notifications.html -->
<!DOCTYPE html>
<html lang="en-US">
  <head>
    <meta charset="UTF-8">
    <title>Notifications | Syndica</title>
  ...
  <div class="container py-3">
    <div class="card">
      <div class="card-header bg-primary text-white">
        <div class="h4 mb-0">Notifications</div>
      </div>
      <div class="card-body">
        <div id="activity">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
              {{.Activity}} &ndash; <span class="text-muted small">{{.Time}}</span>
            </li>
            {{end}}
          </ul>
        </div><!-- #activity -->
